...
def attach_callbacks(model, rc):
    ...
    def on_epoch_start(trainer):
        ...
        for s in seen:
            print(f"  [guard] {s}")
        # NOTE: E2ELoss does NOT define self.hyp — only the two inner v8DetectionLoss
        # objects do. Reading crit.hyp here raises AttributeError inside the callback
        # and kills the run at epoch 1. Read it off the branch instead.
        h = o2o.hyp
