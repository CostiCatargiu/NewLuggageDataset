...
class BboxLoss(nn.Module):
    ...
    def __init__(self, reg_max=16):
        ...
        # Section A defaults (will be overwritten by set_params)
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes,
        ...
        loss_iou = loss_iou.clamp(min=0.0, max=max_iou_clip)
        ...
        if self.dfl_loss:
            ...
            loss_dfl = loss_dfl.clamp(min=0.0, max=max_dfl_clip)
        else:
...
class v8DetectionLoss:
    ...
    def _print_config(self):
        ...
        if not hasattr(self, '_config_printed'):
            ...
            print(f"  [B] center_loss:     {self.center_loss_weight_init}")
