...
RUNS = [
    {"name": "r18_p2head_70",
     ...
     "yaml_content": ARCH_P2HEAD, "batch": 44, "seed": 0},
    {"name": "r18_p2deepcls_70",
     ...
     "yaml_content": ARCH_P2DEEPCLS, "batch": 40, "seed": 0},
    {"name": "r18_deepcls_70",
