...
# =============================================================================
# WEAPON-SATAL-SWA-Plus: SATAL + SWA Loss for Weapon Detection (NO NWD)
# =============================================================================
#
# Adapted from loss_satal_swa_plus.py for weapon dataset
#
...
#
# Features:
#   - SWA (Size-Weight Adaptive) loss weighting
#   - SA-TAL (Scale-Adaptive Task Aligned Assigner)
#   - Class weighting (inverse-frequency)
#   - Adaptive gradient clipping
#   - Center loss for small objects
#   - NO NWD (pure CIoU for bounding box loss)
#
# =============================================================================
...
class BboxLoss(nn.Module):
    """
    Bounding box loss with SWA (Size Weight Adaptive).
    Pure CIoU loss - NO NWD.
    """
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes,
        ...
        """Compute IoU and DFL losses with SWA weighting (pure CIoU, no NWD)."""
...
class v8DetectionLoss:
    """
    WEAPON-SATAL-SWA-Plus Detection Loss (NO NWD).
    ...
    def _print_config(self):
        ...
        if not hasattr(self, '_config_printed'):
            print("\n" + "=" * 60)
            print("WEAPON-SATAL-SWA-Plus Detection Loss Configuration (NO NWD)")
            print("=" * 60)
            ...
            print(f"  [H] NWD: DISABLED (pure CIoU)")
    ...
    def __call__(self, preds, batch):
        ...
        # Bounding box losses (SWA, pure CIoU)
        if fg_mask.sum():
