...
RUNS = [
    {"name": "r21_aux_w50_70",
     ...
     "yaml_content": ARCH_AUX_W50, "batch": BATCH, "seed": 0, "epochs": 80},
    {"name": "r21_aux_w100_70",
     "desc": "[2/4] stock + DetectAux aux_weight=1.00 -- weight sweep point (max)",
     "yaml_content": ARCH_AUX_W100, "batch": BATCH, "seed": 0, "epochs": 80},
    {"name": "r21_widefuse_aux_70",
     "desc": "[3/4] widefuse @ P4 + DetectAux aux_weight=0.25 -- stack best backbone + aux",
     "yaml_content": ARCH_WIDEFUSE_AUX, "batch": BATCH, "seed": 0, "epochs": 80},
    {"name": "r21_widefuse_aux_w50_70",
     "desc": "[4/4] widefuse @ P4 + DetectAux aux_weight=0.50 -- stack + stronger aux",
     "yaml_content": ARCH_WIDEFUSE_AUX_W50, "batch": BATCH, "seed": 0, "epochs": 80},
]
