...
BATCH = 48                   # same as r21/r25 for a clean comparison
...
RUNS = [
    ...
    {"name": "r29_kernelfix",
     ...
     "yaml_content": ARCH_KERNELFIX, "batch": BATCH, "seed": 0, "epochs": 80},
    {"name": "r29_decoupled_aux",
     "desc": "[3/4] A: widefuse[11,23] + DetectDecoupledAux@0.5 (decoupled cls + aux)",
     "yaml_content": ARCH_DECOUPLED_AUX, "batch": BATCH, "seed": 0, "epochs": 80},
