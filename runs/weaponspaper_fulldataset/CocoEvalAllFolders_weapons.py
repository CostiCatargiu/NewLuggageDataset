...
PHASE_FOLDER_PATTERN = r"runs_new_weapon_dataset_full"
...
EVAL_SPLITS = {
    "valid": {
        "coco_ann": "/home/constantin/Doctorat/GunDatasetHistogram/annotations_coco_validfull.json",
        # What the YAML's `val:` field should point at for this pass.
        "yaml_val_path": "../valid/images",
    },
    "test": {
        "coco_ann": "/home/constantin/Doctorat/GunDatasetHistogram/annotations_coco_testfull.json",
...
def build_config(run_dir: Path) -> dict:
    ...
    return cfg
# =============================================================================
# COCO EVALUATION (size-specific + per-class) — unchanged
# =============================================================================
