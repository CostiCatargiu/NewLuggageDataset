...
$best = @($json.results) | Where-Object { $_.name -eq "stock_full_besttal" }

Write-Host "================================================================"
Write-Host "  IMPROVEMENT: stock_full_besttal vs stock_full_default"
Write-Host "  (same architecture, only TAL changed)"
Write-Host "  default TAL: topk=10, alpha=0.5, beta=6.0"
Write-Host "  best TAL:    topk=13, alpha=0.7, beta=4.0"
Write-Host "================================================================"
Write-Host ""

$fmt = "{0,-25} {1,12} {2,12} {3,12} {4,10}"
Write-Host ($fmt -f "Metric","Default","BestTAL","Abs Delta","% Improv")
Write-Host ("-" * 75)
...
Write-Host "================================================================"
Write-Host ""
Write-Host ($fmt -f "Class","Default","BestTAL","Abs Delta","% Improv")
Write-Host ("-" * 75)
...
Write-Host "================================================================"
Write-Host ""
Write-Host ($fmt -f "Class_small","Default","BestTAL","Abs Delta","% Improv")
Write-Host ("-" * 75)
foreach ($cls in @("knife","long_gun","other","pistol")) {
...
Write-Host "================================================================"
Write-Host ""
Write-Host ($fmt -f "Class_medium","Default","BestTAL","Abs Delta","% Improv")
Write-Host ("-" * 75)
foreach ($cls in @("knife","long_gun","other","pistol")) {
...
Write-Host "================================================================"
Write-Host ""
Write-Host ($fmt -f "Class_large","Default","BestTAL","Abs Delta","% Improv")
Write-Host ("-" * 75)
foreach ($cls in @("knife","long_gun","other","pistol")) {
...
Write-Host "================================================================"
Write-Host ""
Write-Host ($fmt -f "Class_5095","Default","BestTAL","Abs Delta","% Improv")
Write-Host ("-" * 75)
foreach ($cls in @("knife","long_gun","other","pistol")) {
