...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk=10):
        ...
        # Section E: SA-TAL (Scale-Adaptive Task Aligned Assigner) parameters
        ...
        # Task Aligned Assigner - use SA-TAL if enabled, otherwise standard TAL
        if self.use_satal:
            ...
            self.assigner = ScaleAdaptiveTaskAlignedAssigner(
                ...
                topk_factor=self.satal_topk_factor
            )
        else:
    ...
    def _print_config(self):
        ...
        if not hasattr(self, '_config_printed'):
            ...
            if self.use_satal:
                print(f"  [E] satal_alpha_small: {self.satal_alpha_small}")
                print(f"  [E] satal_beta_small:  {self.satal_beta_small}")
                print(f"  [E] satal_alpha_large: {self.satal_alpha_large}")
                print(f"  [E] satal_beta_large:  {self.satal_beta_large}")
                print(f"  [E] satal_small_area:  {self.satal_small_area}")
                print(f"  [E] satal_large_area:  {self.satal_large_area}")
                print(f"  [E] satal_topk_factor: {self.satal_topk_factor}")
    ...
    def __call__(self, preds, batch):
        ...
        # Set image size for SA-TAL (if using scale-adaptive assigner)
