...
# =============================================================================
# SATAL-SWA-Plus-NWD6: NWD for All Objects, Uniform C=3.0
# =============================================================================
#
# Base: NWD4
# Change: nwd_small_only = False (apply NWD to ALL objects with same C=3.0)
#
# Rationale:
#   NWD5c proved medium objects benefit from NWD (+1.63% mAP50)
#   but crashed large objects because of tight C=1.5.
#   NWD6 keeps the soft C=3.0 that worked in NWD4, just removes the gate.
#
# =============================================================================
...
class BboxLoss(nn.Module):
    ...
    def __init__(self, reg_max=16):
        ...
        self.nwd_small_only = False         # NWD6: apply to ALL objects, uniform C=3.0
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes,
        ...
        if self.use_nwd:
            ...
            if self._nwd_dbg_count < 30:
                ...
                print(f"[NWD6] nwd mean={nwd.mean().item():.4f} "
...
class v8DetectionLoss:
    """
    SATAL-SWA-Plus-NWD6 Detection Loss.
    ...
    def __init__(self, model, tal_topk=10):
        ...
        self.nwd_small_only = getattr(h, 'nwd_small_only', False)  # NWD6: all objects
    ...
    def _print_config(self):
        ...
        if not hasattr(self, '_config_printed'):
            print("\n" + "=" * 60)
            print("SATAL-SWA-Plus-NWD6 Detection Loss Configuration")
            print("=" * 60)
